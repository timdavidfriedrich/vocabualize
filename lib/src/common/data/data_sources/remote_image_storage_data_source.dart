...
class RemoteImageStorageDataSource {
  ...
  // TODO: Remove buckets (the name is also just a placeholder right now)
  final String _bucketName = ""; //FirebaseStorage.instance.bucket;
  final Reference? _itemImages = null; //FirebaseStorage.instance.ref().child("vocabulary_images");
...
*/
  ...
  Future<Uint8List?> downloadItemImage({required Vocabulary vocabulary}) async {
    try {
      final Uint8List? imageData = null; //await _getImageRefOfVocabulary(vocabulary).getData();
      return imageData;
    } catch (e) {
